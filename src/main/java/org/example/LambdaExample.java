...
///////////////////////////////////////////////////////////
        ...
        Predicate<User>agesGreaterThanFivePredicate=new Predicate<User>() {
            @Override
            public boolean test(User user) {
                return user.age>5;
            }
        };
        repository.select(agesGreaterThanFivePredicate,Comparator.comparing(user -> user.name));
/////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////
        ...
        // TODO With functional interfaces declared
        Predicate<User>agesSmallerThanTenPredicate=new Predicate<User>() {
            @Override
            public boolean test(User user) {
                return user.age<10;
            }
        };
        repository.select(agesSmallerThanTenPredicate,Comparator.comparing(user -> user.age));
        /////////////////////////////////////
       ...
       ////////////////////////////////////
        ...
        // TODO With functional interfaces declared
           repository.select(activeUserPredicate,Comparator.comparing(user -> user.name));
